...
This repository is a thin MCP adapter over [`presidio-hardened-x402`](https://github.com/presidio-v/presidio-hardened-x402). Security controls (PII redaction, spending policy, replay detection, audit logging) are implemented in the parent library — see its [SECURITY.md](https://github.com/presidio-v/presidio-hardened-x402/blob/main/SECURITY.md) for the library-level threat model.
